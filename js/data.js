...
const machineData = [
  {tag:"Direct Military",amt:"$2.89T",amtB:2887,name:"Global Military Spending",
   ...
   detail:"The US spent $954B (down 7.5% — yet still a third of the world total). Europe surged 14% to $864B as rearmament accelerated: Germany hit $114B, up 24%, crossing 2% of GDP for the first time since 1990. China spent $336B, up 7.4%. Russia spent $190B — 7.5% of its GDP. Ukraine spent $84B: 40% of everything its economy produces.",
   pct:100,src:"SIPRI Trends in World Military Expenditure 2025 (April 2026)",url:"https://www.sipri.org/publications/2026/sipri-fact-sheets/trends-world-military-expenditure-2025"},
  {tag:"Weapons of Mass Destruction",amt:"$119B",amtB:119,name:"Nuclear Arsenals",
   ...
   detail:"The United States spent $69.2B — more than all eight other nuclear-armed states combined. China spent $13.5B; the UK ($12.6B) overtook Russia ($9.5B). Roughly 12,200 warheads remain in existence. Every nuclear-armed state is currently modernising or expanding its arsenal.",
   pct:4.1,src:"ICAN — Premeditated: 2025 Global Nuclear Weapons Spending (June 2026)",url:"https://www.icanw.org/premeditated_2025_global_nuclear_weapons_spending"},
  {tag:"Arms Trade",amt:"+9.2%",amtB:120,name:"The Global Arms Trade",
   ...
   detail:"The United States now supplies 42% of all global arms exports, up 27% on the previous period. Ukraine became the world's largest arms importer, taking 9.7% of all global imports. The trade remains one of the least regulated global industries, with pervasive corruption and minimal end-use accountability.",
   pct:4.1,src:"SIPRI Trends in International Arms Transfers 2025 (March 2026)",url:"https://www.sipri.org/publications/2026/sipri-fact-sheets/trends-international-arms-transfers-2025"},
  {tag:"Full Economic Cost",amt:"$21.8T",amtB:21810,name:"Total Impact of Violence",
   ...
   pct:100,src:"IEP Global Peace Index 2026",url:"https://www.visionofhumanity.org/economic-impact-of-violence/"},
];

/* ── TOP MILITARY SPENDERS 2025 (SIPRI, April 2026) ──────────────── */
const topSpenders = [
  {name:"United States",amt:954,change:"−7.5%",note:"33% of the world total"},
  {name:"China",amt:336,change:"+7.4%",note:"31 consecutive years of growth"},
  {name:"Russia",amt:190,change:"+5.9%",note:"7.5% of GDP"},
  {name:"Germany",amt:114,change:"+24%",note:"largest in Western Europe"},
  ...
  {name:"Japan",amt:62.2,change:"+9.7%",note:"largest rise since 1952"},
];

/* ── CHAPTER 02 · THE DESTRUCTION — what war breaks ──────────────── */
const destructionData = [
  {tag:"Ukraine",amt:"$588B",amtB:588,name:"Rebuilding Ukraine",
   ...
   pct:20,src:"Ukraine RDNA5 — World Bank / UN / EU (February 2026)",url:"https://www.worldbank.org/en/news/press-release/2026/02/23/updated-ukraine-recovery-and-reconstruction-needs-assessment-released"},
  {tag:"Gaza",amt:"$71.4B",amtB:71.4,name:"Rebuilding Gaza",
   ...
   pct:2.5,src:"Gaza RDNA — EU / UN / World Bank (April 2026)",url:"https://news.un.org/en/story/2026/04/1167336"},
  {tag:"Post-9/11 Legacy",amt:"$8T+",amtB:8000,name:"The War on Terror",
   ...
   pct:100,src:"Brown University Costs of War Project",url:"https://watson.brown.edu/costsofwar"},
  {tag:"Military Emissions",amt:"~5.5%",amtB:500,name:"The Climate Cost",
   ...
   detail:"If the global military were a country, it would have the fourth-largest carbon footprint on Earth. Military emissions remain systematically excluded from international climate agreements. Wars also destroy ecosystems, contaminate water sources, and push displaced communities into environmental vulnerability for generations.",
   pct:17,src:"Scientists for Global Responsibility / CEOBS",url:"https://www.sgr.org.uk/resources/hidden-carbon-cost-military"},
];
...
const humanData = [
  {num:"244,700",unit:"people killed in armed conflict in the last year",
   ...
   src:"ACLED Conflict Index 2025",url:"https://acleddata.com/series/acled-conflict-index"},
  {num:"1 in 6",unit:"people on Earth were exposed to conflict in 2025",
   ...
   src:"ACLED Conflict Index 2025",url:"https://acleddata.com/series/acled-conflict-index"},
  {num:"11,967",unit:"children killed or maimed in a single year",
   ...
   src:"UN Children and Armed Conflict Report 2025",url:"https://news.un.org/en/story/2025/06/1164646"},
  {num:"117.8M",unit:"people forcibly displaced from their homes",
   ...
   src:"UNHCR Global Trends 2026",url:"https://www.unhcr.org/global-trends"},
  {num:"4.5M+",unit:"deaths attributable to the post-9/11 wars alone",
   ...
   src:"Brown University Costs of War Project",url:"https://watson.brown.edu/costsofwar"},
];

/* ── CHAPTER 05 · THE CHOICE — annual investment gaps (SDGs) ─────── */
const issueData = [
  {sdg:"SDG 2",name:"Zero Hunger",cost:90,color:"#f5a623",
   ...
   detail:"The FAO's SOFI 2025 report estimates 638–720 million people undernourished. In Africa, more than 1 in 5 people face hunger. WFP and FAO estimate $40–90B/year in food-system investment would end acute hunger by 2030 — covering agricultural support, supply-chain reform, and emergency aid.",
   src:"FAO SOFI 2025 + UN WFP",url:"https://www.fao.org/publications/fao-flagship-publications/the-state-of-food-security-and-nutrition-in-the-world/en"},
  {sdg:"SDG 3",name:"Global Health",cost:371,color:"#00e5ff",
   sum:"4.5 billion people lack full access to essential health services. 2 billion face financial hardship paying for care.",
   detail:"WHO's universal health coverage scenario requires 23 million new health workers and 415,000 new facilities. 85% of costs can be met domestically, but the poorest nations face a combined external financing gap of $54B+/year.",
   src:"WHO SDG 3 Financing Study (Stenberg et al.)",url:"https://www.who.int/publications/i/item/9789241513326"},
  {sdg:"SDG 4",name:"Quality Education",cost:100,color:"#b967ff",
   ...
   src:"UNESCO Global Education Monitoring 2025",url:"https://www.unesco.org/en/articles/more-children-out-school-7th-year-row-273-million"},
  {sdg:"SDG 5",name:"Gender Equality",cost:360,color:"#ff67b9",
   sum:"At the current pace, full legal gender parity will not arrive until the 2070s.",
   detail:"UN Women estimates $360B/year for meaningful gender equality — legal reform, education access, economic inclusion, reproductive health, and ending gender-based violence. Women and girls bear a disproportionate and largely invisible share of every war's costs.",
   src:"UN Women Beijing+30 Financing Report",url:"https://www.unwomen.org/en"},
  {sdg:"SDG 6",name:"Clean Water",cost:114,color:"#4488ff",
   sum:"2.2 billion people lack safe drinking water. 3.5 billion lack safely managed sanitation.",
   detail:"OECD and WHO estimate $114B/year in additional investment closes the global water and sanitation gap by 2030. Waterborne disease kills more children annually than armed conflict. Water stress is among the most reliable predictors of future conflict.",
   src:"OECD / WHO GLAAS Water Financing Report",url:"https://www.who.int/teams/environment-climate-change-and-health/water-sanitation-and-health"},
  {sdg:"SDG 7",name:"Clean Energy",cost:35,color:"#f5d623",
   sum:"~675 million people have no electricity. Renewables are now the cheapest new power source in most of the world.",
   detail:"The IEA estimates just $35B/year in targeted additional investment achieves universal energy access by 2030. The barrier is not technology — it is finance. Countries without reliable electricity cannot build the economic base to invest in any other goal.",
   src:"IEA World Energy Outlook",url:"https://www.iea.org/reports/world-energy-outlook-2024"},
  {sdg:"SDG 8",name:"Decent Work",cost:50,color:"#00ff88",
   sum:"160 million children remain in child labour. 21 million people in forced labour.",
   detail:"The ILO estimates $50B/year in social protection and labour reform would end child labour and forced labour by 2030. Youth unemployment is highest in conflict-affected regions — a direct structural pathway to radicalisation. Decent work is the most effective long-term conflict prevention.",
   src:"ILO World Employment and Social Outlook",url:"https://www.ilo.org/global/research/global-reports/weso/en/"},
  {sdg:"SDG 9",name:"Infrastructure",cost:150,color:"#88aaff",
   sum:"2.6 billion people lack reliable internet. Billions lack basic transport, energy, and industrial infrastructure.",
   detail:"UNCTAD estimates $150B+/year in infrastructure investment for developing nations bridges the connectivity gap and enables growth. Without infrastructure, no other development goal is achievable at scale.",
   src:"UNCTAD Technology and Innovation Report",url:"https://unctad.org/publication/technology-and-innovation-report-2023"},
  {sdg:"SDG 10",name:"Reduce Inequality",cost:150,color:"#a0ff00",
   sum:"The richest 1% own more wealth than the bottom 50% of humanity combined.",
   detail:"World Bank and Oxfam models indicate $150B/year in social protection floors, progressive redistribution mechanisms, and tax-reform support can materially reduce extreme inequality in developing nations — and the conditions that make conflict inevitable.",
   src:"Oxfam Inequality Report + World Bank",url:"https://www.worldbank.org/en/topic/poverty/overview"},
  {sdg:"SDG 11",name:"End Homelessness",cost:200,color:"#00ffcc",
   sum:"300 million people have no stable shelter. 1.1 billion live in slums or informal settlements.",
   detail:"UN-Habitat estimates $200B/year for a serious global push on affordable housing — building 100,000 new homes every day. Housing precarity is heavily concentrated in post-conflict zones. Stable shelter is the foundation of every other human development indicator.",
   src:"UN-Habitat World Cities Report",url:"https://unhabitat.org/wcr"},
  {sdg:"SDG 13",name:"Climate Action",cost:1000,color:"#ff6b35",
   ...
   src:"IPCC AR6 + COP29 NCQG + WRI",url:"https://www.wri.org/insights/ncqg-climate-finance-goals-explained"},
  {sdg:"SDG 14",name:"Ocean Health",cost:50,color:"#0088ff",
   sum:"Over a third of fish stocks are at unsustainable levels. Oceans absorb 90% of excess planetary heat.",
   detail:"A $50B/year global ocean fund establishes meaningful marine protected areas, ends destructive fishing subsidies, addresses plastic pollution, and funds coral restoration. The ocean generates $2.5T/year in economic value and produces half the oxygen we breathe.",
   src:"High Level Panel for a Sustainable Ocean Economy",url:"https://oceanpanel.org"},
  {sdg:"SDG 15",name:"Biodiversity",cost:200,color:"#44ff88",
   sum:"1 million species face extinction. Species are being lost up to 1,000× faster than natural rates.",
   detail:"IUCN and IPBES estimate $200B/year halts and begins to reverse biodiversity collapse. Meanwhile, harmful subsidies to nature-destructive industries total $1.8T/year — nine times what conservation receives. Biodiversity collapse undermines every food and water system on Earth.",
   src:"IPBES Global Assessment + IUCN",url:"https://ipbes.net/global-assessment"},
  {sdg:"SDG 16",name:"Peace & Justice",cost:80,color:"#cc88ff",
   ...
   src:"IEP Economics of Peace + UN Peacebuilding Fund",url:"https://www.visionofhumanity.org"},
];
...
const countryData = [
["United States","US",954,3.2,340,"https://www.contactingthecongress.org"],
...
["Australia","AU",34,2.0,26,"https://www.aph.gov.au/senators_and_members"],
